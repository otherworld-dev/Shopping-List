<template>
	<NcContent app-name="shoppinglist">
		<NcAppNavigation>
			<ListSidebar />
		</NcAppNavigation>
		<NcAppContent>
			<ListView v-if="listsStore.currentList" />
...
const noListName = t('shoppinglist', 'No list selected')
const noListDesc = t('shoppinglist', 'Select a list from the sidebar or create a new one')
