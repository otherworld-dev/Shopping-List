...
const backText = t('shoppinglist', 'Back to lists')
const title = t('shoppinglist', 'Area Keywords')
const description = t('shoppinglist', 'Keywords are used to auto-detect which shop area an item belongs to when added or pasted.')
const searchPlaceholder = t('shoppinglist', 'Search keywords...')
const addPlaceholder = t('shoppinglist', 'Add keyword...')
const noKeywordsText = t('shoppinglist', 'No keywords')
const resetText = t('shoppinglist', 'Reset to defaults')
