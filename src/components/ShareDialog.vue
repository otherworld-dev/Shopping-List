...
const shareTitle = t('shoppinglist', 'Share list')
const searchPlaceholder = t('shoppinglist', 'Search users or groups...')
const noResultsText = t('shoppinglist', 'No users found')
const groupText = t('shoppinglist', 'Group')
const sharedWithText = t('shoppinglist', 'Shared with')
const canViewText = t('shoppinglist', 'Can view')
const canEditText = t('shoppinglist', 'Can edit')
const emptyText = t('shoppinglist', 'Search above to share this list with other users.')
