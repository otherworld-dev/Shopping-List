...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-DzU8UWcN.chunk.mjs").then((n) => n.i);
        return { listen };
