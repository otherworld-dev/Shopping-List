...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-Dw468IGo.chunk.mjs").then((n) => n.i);
        return { listen };
