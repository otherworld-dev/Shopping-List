...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-CZy0n3J1.chunk.mjs").then((n) => n.i);
        return { listen };
