...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-BcrEjgKM.chunk.mjs").then((n) => n.i);
        return { listen };
