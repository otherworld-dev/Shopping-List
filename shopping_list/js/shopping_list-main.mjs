...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-pi0l9tvU.chunk.mjs").then((n) => n.i);
        return { listen };
