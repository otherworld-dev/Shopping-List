...
const useShopAreasStore = defineStore("shopAreas", () => {
  ...
  async function loadLanguageKeywords(listId) {
    try {
      const response = await api.areas.applyKeywords(listId);
      areasByList.value[listId] = response.data.ocs.data;
      showSuccess(translate("shopping_list", "Keywords for your language added"));
    } catch (e) {
      showError(translate("shopping_list", "Failed to add keywords"));
      console.error(e);
    }
  }
  return {
...
const units$n = ["teelusikka", "teelusikallista", "tl", "ruokalusikallinen", "ruokalusikallista", "rkl", "kupillinen", "kupillista", "unssi", "unssia", "unssi", "pauna", "paunaa", "pauna", "paunaa", "gramma", "grammaa", "g", "kilogramma", "kilogrammaa", "kg", "millilitra", "millilitraa", "ml", "litra", "litraa", "l", "ripaus", "hyppysellistä", "nippu", "nippua", "kynsi", "kynttä", "tölkki", "tölkkiä", "pullo", "pulloa", "kappale", "kappaletta", "viipale", "viipaletta", "pää", "päitä", "varsi", "vartta", "oksa", "oksaa", "pakkaus", "pakkausta", "paketti", "pakkausta", "pussi", "pussia", "fl oz"];
const leadingUnits$n = ["ripaus", "hyppysellistä", "nippu", "nippua", "kuori", "viiva", "kourallinen"];
...
const useItemsStore = defineStore("items", () => {
  ...
  async function create(listId, data) {
    try {
      ...
      const match = data.checked ? void 0 : findMatchingItem(existingItems, data.name);
      if (match) {
...
const _hoisted_16$2 = { class: "input-help__name" };
const _hoisted_17$2 = {
  key: 1,
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(inputExamples), (example) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", {
                          ...
                          example.quantity ? (openBlock(), createElementBlock("span", _hoisted_15$2, toDisplayString(example.quantity), 1)) : createCommentVNode("", true),
                          _cache[4] || (_cache[4] = createTextVNode()),
                          createBaseVNode("span", _hoisted_16$2, toDisplayString(example.name), 1),
                          _cache[5] || (_cache[5] = createTextVNode()),
                          example.checked ? (openBlock(), createElementBlock("span", _hoisted_17$2, toDisplayString(unref(checkedOffText)), 1)) : createCommentVNode("", true)
                        ], 2)
                      ]);
                    }), 128))
                  ])
...
const _hoisted_15$1 = { class: "share-modal__share-info" };
const _hoisted_16$1 = { class: "share-modal__share-name" };
const _hoisted_17$1 = {
  key: 0,
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(shares.value, (share) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_15$1, [
                  createBaseVNode("span", _hoisted_16$1, toDisplayString(share.sharedWithDisplayName), 1),
                  share.sharedWithType === 1 ? (openBlock(), createElementBlock("span", _hoisted_17$1, toDisplayString(unref(groupText)), 1)) : createCommentVNode("", true)
                ]),
              ...
              createBaseVNode("div", _hoisted_28$1, [
                createBaseVNode("label", _hoisted_29$1, [
                  ...
                  createBaseVNode("select", {
                    ...
                    createBaseVNode("option", _hoisted_31$1, toDisplayString(unref(canViewText)), 1),
...
function loadBoughtSort(storage) {
  ...
  try {
    ...
    return SORTS.find((sort2) => sort2 === raw) ?? "list";
  } catch {
    return "list";
  }
}
function saveBoughtSort(storage, sort2) {
  ...
  try {
    if (sort2 === "list") {
      ...
      storage.setItem(STORAGE_KEY, sort2);
    }
  } catch {
  }
}
...
const _hoisted_11$1 = { class: "list-view__bought-header" };
const _hoisted_12$1 = { class: "list-view__toggle" };
const _hoisted_13$1 = {
  key: 0,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const boughtSortOptions = [
      { value: "list", label: translate("shopping_list", "List order") },
      { value: "alpha", label: translate("shopping_list", "Alphabetical") },
      { value: "recent", label: translate("shopping_list", "Most recent first") }
    ];
    const storage = browserStorage();
    const savedBoughtSort = ref(loadBoughtSort(storage));
    const boughtSort = computed({
      get: () => savedBoughtSort.value,
      set: (sort2) => {
        savedBoughtSort.value = sort2;
        saveBoughtSort(storage, sort2);
      }
    });
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
              ...
              default: withCtx(() => [
                ...
                (openBlock(), createElementBlock(Fragment, null, renderList(boughtSortOptions, (option2) => {
                  return createVNode(unref(NcActionRadio), {
                    key: option2.value,
                    modelValue: boughtSort.value,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => boughtSort.value = $event),
              ...
              return openBlock(), createElementBlock("div", {
                ...
                hasHeader(group) ? (openBlock(), createElementBlock("button", {
                  ...
                  createVNode(unref(NcIconSvgWrapper), {
                    ...
                    size: 18,
                    class: normalizeClass(["list-view__area-chevron", { "list-view__area-chevron--collapsed": isGroupCollapsed(group) }])
                  }, null, 8, ["path", "class"]),
                  createBaseVNode("span", {
                    class: normalizeClass(["list-view__area-name", { "list-view__area-name--muted": !group.areaName }])
                ...
                withDirectives(createVNode(unref(draggable), {
                  ...
                  item: withCtx(({ element }) => [
                    createVNode(ItemRow, {
                      ...
                      onCloseEdit: _cache[3] || (_cache[3] = ($event) => editingItemId.value = null)
                    }, null, 8, ["item-id", "list-id", "can-edit", "editing"])
                  ]),
                  _: 1
                }, 8, ["id", "modelValue", "onUpdate:modelValue", "disabled"]), [
        ...
        !unref(itemsStore).loading && unref(itemsStore).checkedItems.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
          createBaseVNode("div", _hoisted_11$1, [
            createBaseVNode("h3", {
              onClick: _cache[5] || (_cache[5] = ($event) => showChecked.value = !showChecked.value)
            }, [
            ...
            canEdit.value ? (openBlock(), createElementBlock("div", _hoisted_13$1, [
              createBaseVNode("button", {
          ...
          showChecked.value ? (openBlock(), createElementBlock("div", _hoisted_14$1, [
        ...
        showShareDialog.value && unref(listsStore).currentList ? (openBlock(), createBlock(ShareDialog, {
          ...
          onClose: _cache[6] || (_cache[6] = ($event) => showShareDialog.value = false)
        }, null, 8, ["list-id", "is-owner", "current-user-id"])) : createCommentVNode("", true)
      ]);
    };
  }
});
const ListView = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["__scopeId", "data-v-af7601f9"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loadLangText = translate("shopping_list", "Load keywords for my language");
    const loadLangHint = translate("shopping_list", "Adds your language's grocery keywords to the default areas, so items auto-sort correctly. Existing keywords are kept.");
    const search = ref("");
...
function usePush() {
  ...
  if (hasPushServer) {
    try {
      __vitePreload(async () => {
        const { listen } = await import("./index-DYc9KUm4.chunk.mjs").then((n) => n.i);
        return { listen };
